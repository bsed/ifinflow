 ...
 public class ProcessResumeCmd
   extends AbstractCommand<Void>
 {
   private static final long serialVersionUID = 1L;
   private String processId;
   
   public ProcessResumeCmd(String processId)
   {
   ...
   public Void execute(Environment environment) throws Exception {
     ...
     process = (ExecutionImpl)dbSession.createProcessInstanceQuery().dbid(this.processId).uniqueResult();

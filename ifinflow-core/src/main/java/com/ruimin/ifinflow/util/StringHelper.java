...
public final class StringHelper {
	...
	public static String unqualify(String qualifiedName) {
		...
		return loc < 0 ? qualifiedName : qualifiedName.substring(qualifiedName
				.lastIndexOf(".") + 1);
	}
	...
	public static List<Object> toList(String listText) {
	...
	public static Map<String, Object> toMap(String mapText) {
	...
	public static String stringPlusN(String tm, Integer n) {
		return String.valueOf(Integer.parseInt(tm) + n.intValue());
	}
}
